...
// OAuth client credentials are supplied at runtime so the public repository does
// not contain provider credentials. Set both environment variables before OAuth.
var (
	ClientID     = os.Getenv("CLIPROXY_ANTIGRAVITY_CLIENT_ID")
	ClientSecret = os.Getenv("CLIPROXY_ANTIGRAVITY_CLIENT_SECRET")
)
